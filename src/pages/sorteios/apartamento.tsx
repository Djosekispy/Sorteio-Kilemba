...
export default function SorteadosdeApartamento(){
  ...
  doc.save('lista-candidatos-apartamentos.pdf');
};
...
ColetarCadastrados();
   ...
   { getAdmim === "globof129@gmail.com" &&   <div className='mx-3'>
    ...
    <p className='text-dark titleDiv px-3 titleHouse'>Sorteados nos Apartamentos</p>
    </div>
    <div>
  <div>
