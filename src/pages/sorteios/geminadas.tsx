...
export default function SorteadosdeGeminadas(){
...
const getAdmim = auth?.currentUser?.email;
 ...
 const handleGeneratePdf = () => {
  ...
  doc.save('lista-candidatos-VivendasGeminadas.pdf');
};
...
ColetarCadastrados();
    ...
    <p className='text-dark titleDiv px-3 titleHouse'>Sorteados nas Vivandas Geminadas</p>
    </div>
    <div>
  <div>
